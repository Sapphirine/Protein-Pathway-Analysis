...
def generate_json(pro_list,upper = 1.6,lower = 1/1.6,min_periods = 10,threholds = 0.95):
    ...
    score_to_graph(pro_list, threholds, exs, upper, lower)
    corr_to_json(pro_list,threholds, exs, upper, lower, corr)
    to_corr_json(pro_list, threholds, exs, upper, lower, corr)

def score_to_graph(pro_list, threholds, exs, upper, lower):
    nodes = []
...
def corr_to_json(pro_list, threholds, exs, upper, lower, corr):
    nodes = []
    links = []
...
def to_corr_json(pro_list, threholds, exs, upper, lower, corr):
    json_dict = {}
    ...
    # json_dict['dat'] = np.nan_to_num(json_dict['dat']).tolist()
